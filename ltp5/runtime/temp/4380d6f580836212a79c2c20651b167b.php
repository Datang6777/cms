<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"D:\wamp\www\1\ltp5\public/../application/admin\view\index.html";i:1478177808;s:70:"D:\wamp\www\1\ltp5\public/../application/admin\view\public\header.html";i:1478789579;s:70:"D:\wamp\www\1\ltp5\public/../application/admin\view\public\footer.html";i:1477149091;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="footer">
            <div class="pull-right">&copy; 2016-2017 轮回后台管理 版权所有
            </div>
        </div>
    </div>
    <!--右侧部分结束-->
    ...
    $(function(){
        $("#cache").click(function(){
            layer.confirm('你确定要清除缓存吗？', {icon: 3}, function(index){
                layer.close(index);
                window.location.href="<?php echo url('admin/Setting/clear_cache'); ?>";
            });
        });
    });
</script>
