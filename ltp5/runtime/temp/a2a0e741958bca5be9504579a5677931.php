<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"D:\wamp\www\1\ltp5\public/../application/admin\view\log\operate_log.html";i:1478789578;s:70:"D:\wamp\www\1\ltp5\public/../application/admin\view\public\header.html";i:1478789579;s:70:"D:\wamp\www\1\ltp5\public/../application/admin\view\public\footer.html";i:1477149091;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                 <select class="form-control m-b chosen-select" name="key" id='key'>
                                    ...
                                    <?php if(is_array($search_user) || $search_user instanceof \think\Collection): $i = 0; $__LIST__ = $search_user;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
