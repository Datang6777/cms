<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"D:\wamp\www\1\ltp5\public/../application/admin\view\article\index.html";i:1479215197;s:70:"D:\wamp\www\1\ltp5\public/../application/admin\view\public\header.html";i:1478789579;s:70:"D:\wamp\www\1\ltp5\public/../application/admin\view\public\footer.html";i:1477149091;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
function del_article(id){
    layer.confirm('确认删除此文章?', {icon: 3, title:'提示'}, function(index){
        //do something
        $.getJSON('./del_article', {'id' : id}, function(res){
            if(res.code == 1){
 ...
 */
function article_state(val){
    $.post('<?php echo url("article_state"); ?>',
    {id:val},
    function(data){
